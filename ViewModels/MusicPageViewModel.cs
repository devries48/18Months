...
public partial class MusicPageViewModel : ObservableObject
{
    ...
    [RelayCommand]private void ReleaseTap(ReleaseModel tappedItem)
    {
    ...
    public async Task GetLocalReleasesAsync()
    {
        ...
        var release = await ReleaseModel.Create("Charles Mingus", "Blues & Roots", ImagePath("Blues Roots-front.jpg"), CountryCode.USA, 1960).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Herbie Hancock", "Head Hunters", ImagePath("Head Hunters-front.jpg"), CountryCode.USA, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Ozzy Osbourne", "No More Tears", ImagePath("No More Tears-front.jpg"), CountryCode.GBR, 1991).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("King Crimson", "Red", ImagePath("Red-front.jpg"), CountryCode.GBR, 1974).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Fifty Foot Hose", "Cauldron", ImagePath("Cauldron-front.jpg"), CountryCode.USA, 1968).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("CAN", "Soundtracks", ImagePath("Soundtracks-front.jpg"), CountryCode.DEU, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Amon Düül II", "Yeti", ImagePath("Yeti-front.jpg"), CountryCode.DEU, 1970).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("CAN", "Ege Bamyasi", ImagePath("Ege Bamyasi-front.jpg"), CountryCode.DEU, 1972).ConfigureAwait(false);
        release.AddGenres("Krautrock", "Psychedelic Rock");
        ...
        release = await ReleaseModel.Create("Magma", "Kobaïa", ImagePath("Kobaia-front.jpg"), CountryCode.FRA, 1970).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Catapilla", "Catapilla", ImagePath("Catapilla-front.jpg"), CountryCode.GBR, 1971).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Magma", "Mekanïk Destruktïẁ Kommandöh", ImagePath("Mdk-front.jpg"), CountryCode.FRA, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("CAN", "Tago Mago", ImagePath("Tago Mago-front.jpg"), CountryCode.DEU, 1971).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Amon Düül II", "Phallus Dei", ImagePath("Phallus-front.jpg"), CountryCode.DEU, 1969).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Joe McPhee", "Nation Time", ImagePath("Nation Time-front.jpg"), CountryCode.USA, 1970).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Area", "Arbeit macht frei", ImagePath("Arbeit-front.jpg"), CountryCode.ITA, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("King Crimson", "In the Court of the Crimson King", ImagePath("Court-front.jpg"), CountryCode.GBR, 1969).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Miles Davis", "Ascenseur pour l'échafaud", ImagePath("Ascenseur-front.jpg"), CountryCode.USA, 1958).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Opeth", "Blackwater Park", ImagePath("Blackwater-front.jpg"), CountryCode.SWE, 2001).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Deep Purple", "Who Do We Think We Are", ImagePath("Who-front.jpg"), CountryCode.GBR, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Savatage", "Gutter Ballet", ImagePath("Gutter-front.jpg"), CountryCode.USA, 1989).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Bubu", "Anabelas", ImagePath("Anabelas-front.jpg"), CountryCode.ARG, 1978).ConfigureAwait(false);
        release.AddGenres("Progressive Rock");
        ...
        release = await ReleaseModel.Create("Banco Del Mutuo Soccorso", "Banco Del Mutuo Soccorso", ImagePath("Banco-front.jpg"), CountryCode.ITA, 1972).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Banco Del Mutuo Soccorso", "Io Sono Nato Libero", ImagePath("Io Sono-front.jpg"), CountryCode.ITA, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Osanna", "L'Uomo", ImagePath("Osanna-front.jpg"), CountryCode.ITA, 1971).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Osanna", "Palepoli", ImagePath("Palepoli-front.jpg"), CountryCode.ITA, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Quella Vecchia Locanda", "Il tempo della gioia", ImagePath("Tempo-front.jpg"), CountryCode.ITA, 1974).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Premiata Forneria Marconi", "Per un amico", ImagePath("Amico-front.jpg"), CountryCode.ITA, 1972).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Charles Mingus", "Mingus Ah Um", ImagePath("Mingus-front.jpg"), CountryCode.USA, 1959).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Mercyful Fate", "Don't Break the Oath", ImagePath("Oath-front.jpg"), CountryCode.DNK, 1984).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Camel", "Mirage", ImagePath("Mirage-front.jpg"), CountryCode.GBR, 1974).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Koenjihyakkei", "Angherr Shisspa", ImagePath("Angherr Shisspa-front.jpg"), CountryCode.JPN, 2005).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Kollektiv", "Kollektiv", ImagePath("Kollektiv-front.jpg"), CountryCode.DEU, 1973).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Brainstorm", "Smile a While", ImagePath("Smile-front.jpg"), CountryCode.DEU, 1972).ConfigureAwait(false);
        ...
        release = await ReleaseModel.Create("Dün", "Eros", ImagePath("Eros-front.jpg"), CountryCode.FRA, 1981).ConfigureAwait(false);
